...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_json_folder", default="home/jthe/RSDM/output/json/", type=str)
    parser.add_argument("--output_mask_folder", default="home/jthe/RSDM/output/mask/", type=str)
